...

{
  ...
  users.users.artslob = {
    ...
    initialHashedPassword = "$6$pMUxmD1xGTuyNGy2$4M2s8wWzN4xuRA/vdJ3pToP.Fh5WLr9ldMKT3wOM.LX3kOpi9UrzjzvNZWbb4rq03zJ3V9Yc2m71tWWKjvPuU0";
  ...
  security.acme = {
    ...
    certs."www.artslob.me" = {
      ...
      extraDomainNames = [
        "subd-rk-1.artslob.me"
        "subd-rk-2.artslob.me"
      ];
    };
  };
